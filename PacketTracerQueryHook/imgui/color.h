...
namespace colors {
    ...
    inline ImVec4 Tab_Border = ImColor(255, 26, 26, 255);

    inline ImVec4 Tab_Selected = ImColor(255, 0, 0,255);
    inline ImVec4 Tab_Hovered = ImColor(180, 0, 0, 255);
    inline ImVec4 Tab = ImColor(255, 255, 255, 255);

    inline ImVec4 Checkbox = ImColor(14, 14, 14, 255);
    inline ImVec4 Checkbox_Hovered = ImColor(12, 12, 12, 255);
    inline ImVec4 Checkbox_Active = ImColor(255, 38, 21, 255);
